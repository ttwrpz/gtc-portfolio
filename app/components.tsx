...
export function CertLink(
    ...
    return (
        <a style={{gridArea: gridArea, order: order}} className="transition-transform scale-100 hover:scale-105" href={href} target="_blank">
            <div className="xl:grid grid-cols-1 grid-rows-1 relative xl:min-h-[22em]">
                <Image style={{gridArea: "1 / 1 / 2 / 2"}} src={isHrefSame ? href : (imageHref ?? "")} alt={name} fill={true} className="object-contain !static !w-full !h-fit xl:relative xl:w-full xl:h-full" />
